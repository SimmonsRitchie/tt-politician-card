      ...
      {CONTACT_BUTTONS.map(({ label, value, icon }) => {
        ...
        return (
          <a
            ...
            className="rounded w-full  uppercase text-xs font-bold px-4 py-3 text-white bg-green-trib hover:bg-opacity-60 transition-all duration-300 flex items-center justify-center"
          >
